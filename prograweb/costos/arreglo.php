...
class RandomTable{
    ...
    function getAllInfo(){
        //Creamos la consulta
        $sql = 'select costo, page_views, fecha, cloudfront,ec2 from costos.diario where id_cuenta=(select id_cuenta from costos.cuenta where nombre="latercerav2") and fecha>=(DATE_SUB(CURRENT_DATE, INTERVAL 7 DAY))';
