...
try:
   cursor.execute("insert into costos.diario(id_cuenta, costo, fecha,visitas) values((select id_cuenta from costos.cuenta where nombre='latercerav2'), round(%s,2),%s,%s)", (valor,uno,int(output)))
